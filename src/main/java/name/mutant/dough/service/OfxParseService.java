...
public class OfxParseService {
    ...
    public OfxParseResponse parseUploadedFile(DataFile dataFile) throws DoughOfxParseException {
            ...
            if (state == State.OFX) {
                ...
                if (line.contains(FI)) {
                    ...
                    try {
                        ...
                        throw new DoughOfxParseException("Error parsing post date in line=\"" + line + "\".", e);
                    }
                } else if (line.contains(DTUSER)) {
                    ...
                    try {
                        ...
                        throw new DoughOfxParseException("Error parsing user date in line=\"" + line + "\".", e);
                    }
                } else if (line.contains(TRNAMT)) {
    ...
    private void badState(State state) throws DoughOfxParseException {
        throw new DoughOfxParseException("Invalid state=\"" + state + "\".");
    }

    private void badToken(State state, String line) throws DoughOfxParseException {
        throw new DoughOfxParseException("Invalid token found: state=\"" + state + "\", line=\"" + line + "\".");
    }

    private void missingToken(State state, String line) throws DoughOfxParseException {
        throw new DoughOfxParseException("No valid token found: state=\"" + state + "\", line=\"" + line + "\".");
    }
}